...
module.exports = function (/* ctx */) {
  return {
    ...
    animations: [
      //'bounceInLeft', //no viene x default
      //'bounceOutRight', //no viene x default
      //'bounceIn', //no viene x default
      //'bounceOut', //no viene x default
      //'fadeInLeft', //no viene x default
