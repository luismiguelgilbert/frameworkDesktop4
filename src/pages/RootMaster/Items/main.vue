...
export default ({
    ...
    data () {
        return {
            moduleName: "Items", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMaster/Items',
            rptName_: 'Detalle de Items', rptLink_: 'mktPO', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
