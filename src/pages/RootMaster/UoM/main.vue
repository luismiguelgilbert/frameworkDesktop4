...
export default ({
    ...
    data () {
        return {
            moduleName: "UoM", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMaster/UoM',
            rptName_: 'Datos de Unidades', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
