  ...
  <div style="height: calc(100vh - 180px);" >
    <q-card class="absolute-center">
        ...
        <q-img
            ...
            :src="serverFilesPath + upload_file_name"
...
export default ({
    data () {
        return {
            moduleName: "Warehouses", row_id: 5/*5=Foto Bodega*/, isDialogVisible: false, fileToUpload: null,
        }
    },
    methods:{
        ...
        finish(){
            ...
            this.picture_attach_ID = this.fileToUpload.attach_id
    ...
    computed:{
        ...
        upload_file_name: {
            get () { return this.$store.state[this.moduleName].editData.basic.upload_file_name },
            set (val) { this.$store.commit((this.moduleName)+'/updateEditData', {section: 'basic', key: 'upload_file_name', value: val}) }
        },
        picture_attach_ID: {
            get () { return this.$store.state[this.moduleName].editData.basic.picture_attach_ID },
            set (val) { this.$store.commit((this.moduleName)+'/updateEditData', {section: 'basic', key: 'picture_attach_ID', value: val}) }
        },
        editMode: {
