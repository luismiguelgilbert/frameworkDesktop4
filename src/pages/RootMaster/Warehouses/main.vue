...
export default ({
    ...
    data () {
        return {
            moduleName: "Warehouses", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMaster/Warehouses',
            rptName_: 'Datos de Bodega', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
