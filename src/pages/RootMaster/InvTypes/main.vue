...
export default ({
    ...
    data () {
        return {
            moduleName: "InvTypes", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMaster/InvTypes',
            rptName_: 'Datos de Marcas', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
