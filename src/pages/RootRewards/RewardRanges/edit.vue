...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            spSelectName: 'spRewRangesSelectEdit',
            spUpdateName: 'spRewRangesUpdate',
            toolbarTitle: "Tablas de Rangos de Comisiones",
            toolbarTitleName: "basic.name_es",
            startTab: 'basic',
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Información Básica', isTabDisable: false, rootPath:'pages', importPath: 'RootRewards/RewardRanges/RewardRangesEditBasic.vue' },
                //{ tabName: 'details', iconName: 'fas fa-sliders-h', textLabel: '', isTabDisable: false, rootPath:'pages', importPath: 'RootRewards/RewardRanges/RewardRangesEditRanges.vue' },
                { tabName: 'details', iconName: 'fas fa-sliders-h', textLabel: 'Detalle de Rangos', isTabDisable: false, rootPath:'components', importPath: 'editForm/editFormGrid.vue',
                    tabConfig: { 
                        dataName: 'rewRangesLines', 
                        ...
                        columns: [
                            ...
                            {alignment: 'right', allowEditing: true, isDataRequired: true, caption: 'Desde', dataField: 'startValue', dataType: 'number', visible: true },
                            {alignment: 'right', allowEditing: true, isDataRequired: true, caption: 'Hasta', dataField: 'stopValue', dataType: 'number', visible: true },
                            {alignment: 'right', allowEditing: true, isDataRequired: true, caption: 'Resultado', dataField: 'resultValue', dataType: 'number', visible: true },
                            //, lookupOptions: [{value: 1, label: 'Domicilio'}, {value: 2, label: 'Celular'} ]
            ...
            editDataSaveProperties: [
                ...
                { name: 'rewRangesLines', filterBy: null, fields: null },
            ],
