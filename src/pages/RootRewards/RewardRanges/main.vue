...
export default ({
    ...
    data () {
        return {
            moduleName: "RewardRanges", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootRewards/RewardRanges',
            rptName_: 'Tablas de Comisiones', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
