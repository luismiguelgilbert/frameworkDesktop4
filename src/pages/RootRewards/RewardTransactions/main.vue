...
export default ({
    ...
    data () {
        return {
            moduleName: "RewardTransactions", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootRewards/RewardTransactions',
            rptName_: 'Datos de Cálculo de Comisiones', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
