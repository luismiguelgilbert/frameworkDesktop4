...
export default ({
    ...
    data () {
        return {
            moduleName: "casCasesTypes", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootCases/casCasesTypes',
            rptName_: 'Datos de Tipos', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
