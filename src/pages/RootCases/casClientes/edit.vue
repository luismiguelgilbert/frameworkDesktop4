    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            moduleTabs: [
                ...
                { tabName: 'contacts', iconName: 'fas fa-address-book', textLabel: 'Contactos del Cliente', isTabDisable: false, rootPath:'components', importPath: 'editForm/editFormGrid.vue',
                    tabConfig: { 
                        dataName: 'contacts', 
                        keyColumn: 'contactID', 
                ...
                { tabName: 'cases', iconName: 'fas fa-folder-open', textLabel: 'Casos del Cliente', isTabDisable: false, rootPath:'components', importPath: 'editForm/editFormGrid.vue',
                    tabConfig: { 
                        dataName: 'cases', 
                        keyColumn: 'value', 
                        ...
                        columns: [
                            //'string' | 'number' | 'date' | 'boolean' | 'object' | 'datetime'
                            {alignment: 'left', allowEditing: false, isDataRequired: true, caption: 'Código', dataField: 'value', dataType: 'number', visible: false },
                            {alignment: 'left', allowEditing: false, isDataRequired: true, caption: 'Caso', dataField: 'label', dataType: 'string', visible: true },
                            {alignment: 'left', allowEditing: false, isDataRequired: true, caption: 'Tipo', dataField: 'caseTypeName', dataType: 'string', visible: true },
                            {alignment: 'left', allowEditing: false, isDataRequired: true, caption: 'Fecha Inicio', dataField: 'startDate', dataType: 'date', visible: true, format: 'dd-MMM-yyyy' },
                            //{alignment: 'center', allowEditing: true, isDataRequired: true, caption: 'Activo', dataField: 'estado', dataType: 'boolean', visible: true },
                        ]
                    }
                },
