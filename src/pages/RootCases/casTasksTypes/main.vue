...
export default ({
    ...
    data () {
        return {
            moduleName: "casTasksTypes", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootCases/casTasksTypes',
            rptName_: 'Datos de Actividad', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
