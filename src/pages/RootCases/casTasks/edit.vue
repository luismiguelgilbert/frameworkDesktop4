    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            moduleTabs: [
                ...
                { tabName: 'next', iconName: 'fas fa-calendar', textLabel: 'Información Actividad', isTabDisable: false, rootPath:'pages', importPath: 'RootCases/casTasks/casTasksEditNext.vue' },
