    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            moduleTabs: [
                ...
                { tabName: 'budget', iconName: 'fas fa-file-invoice-dollar', textLabel: 'Presupuesto de Insumos', isTabDisable: false, rootPath:'pages', importPath: 'RootMFG/mfgBOM/mfgBOMEditBudget.vue' },
