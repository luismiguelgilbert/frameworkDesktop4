...
export default ({
    ...
    data () {
        return {
            moduleName: "mfgTypes", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMFG/mfgTypes',
            rptName_: 'Tipos de Producción', rptLink_: 'mfgTypes', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
