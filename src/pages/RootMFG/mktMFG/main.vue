...
export default ({
    ...
    data () {
        return {
            moduleName: "mktMFG", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMFG/mktMFG',
            rptName_: 'Pedido de Insusmos', rptLink_: 'mktMFG', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
