...
export default ({
    ...
    data () {
        return {
            moduleName: "mktPRD", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMFG/mktPRD',
            rptName_: 'Entrega de PT', rptLink_: 'mktPRD', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
