...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            spSelectName: 'spMktPRDSelectEdit',
            spUpdateName: 'spMktPRDUpdate',
            toolbarTitle: "Entrega de Producto Terminado",
            startTab: 'basic',
            splitterModel: 230,
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Datos de la Orden', isTabDisable: false, rootPath:'pages', importPath: 'RootMFG/mktPRD/mktPRDEditBasic.vue' },
                { tabName: 'lines', iconName: 'fas fa-list-ol', textLabel: 'Producción Final', isTabDisable: false, rootPath:'pages', importPath: 'RootMFG/mktPRD/mktPRDEditLines.vue' },
                { tabName: 'status', iconName: 'fas fa-shipping-fast', textLabel: 'Mi Pedido', isTabDisable: false, rootPath:'pages', importPath: 'RootMFG/mktPRD/mktPRDEditWH.vue' },
