...
export default ({
    ...
    data () {
        return {
            moduleName: "mktMFGreturn", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMFG/mktMFGreturn',
            rptName_: 'Devolución de Insusmos', rptLink_: 'mktMFGreturn', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
