...
export default ({
    ...
    data () {
        return {
            moduleName: "mfgOrders", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMFG/mfgOrders',
            rptName_: 'Orden de Producción', rptLink_: 'mfgOrders', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
