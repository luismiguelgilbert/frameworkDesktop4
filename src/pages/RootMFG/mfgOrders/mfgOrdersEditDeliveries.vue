...
<div style="margin: -16px;">
    <DxDataGrid
        ...
        <DxColumn caption="Cantidad PT" data-field="qtyIN" name="qtyIN" data-type="number" :allow-editing="true" alignment="right" :width="100"  :editor-options="{ min: 0 }" />
        <DxColumn caption="Cantidad Real" data-field="qtyINReal" name="qtyINReal" data-type="number" :allow-editing="true" alignment="right" :width="100" :editor-options="{ min: 0 }" :cssClass="userColor=='default'?'bg-grey-2':'bg-grey-9'" />
        <DxSummary >
