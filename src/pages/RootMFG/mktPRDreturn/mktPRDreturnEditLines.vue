...
<div style="margin: -16px;">
  <q-toolbar class="no-padding">
    <q-btn label="Entregas de PT" icon="fas fa-file-alt" color="primary" flat stretch @click="isRequisicionesDialog=true" :disable="!allow_row_insert" />
  ...
  <DxDataGrid
    ...
    >
      ...
      <DxColumn caption="# Entrega PT" data-field="mktPRD_headerID" name="mktPRD_headerID" data-type="number" :allow-editing="false" alignment="right" :width="80" :visible="true" cssClass="text-primary" />
      <DxColumn caption="# Entrega PT Línea" data-field="mktPRD_lineID" name="mktPRD_lineID" data-type="number" :allow-editing="false" alignment="right" :width="110" :visible="true" cssClass="text-primary" />
    ...
    >
        ...
        <div style="margin: -15px;">
          ...
          <DxDataGrid
            ...
            <DxColumn caption="# Entrega PT" data-field="mktPRD_headerID" data-type="number" :allow-editing="false" alignment="left" :visible="true" :minWidth="70" />
            <DxColumn caption="# Entrega PT Línea" data-field="mktPRD_lineID" data-type="number" :allow-editing="false" alignment="left" :visible="true" :minWidth="70" />
            <DxColumn caption="# OP" data-field="mfg_orderID" data-type="number" :allow-editing="false" alignment="left" :visible="true" :minWidth="70" />
      ...
      this.requisiciones.filter(x=>this.requisicionesSelectedRowKeys.some(y=>y==x.moveID)).map(row=>{
        if( newGridData.some(t=>t.moveID==row.moveID) && newGridData.some(t=>t.kardexID==row.kardexID) ){
          ...
          const newRow = {
            ...
            stockID: row.stockID,
            moveID: row.moveID,
            mktPRD_headerID: row.mktPRD_headerID,
            mktPRD_lineID: row.mktPRD_lineID,
            mfg_orderID: row.mfg_orderID,
          }
