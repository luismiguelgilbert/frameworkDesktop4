...
export default ({
    ...
    data () {
        return {
            moduleName: "mktPRDreturn", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMFG/mktPRDreturn',
            rptName_: 'Devolución de PT', rptLink_: 'mktPRDreturn', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
