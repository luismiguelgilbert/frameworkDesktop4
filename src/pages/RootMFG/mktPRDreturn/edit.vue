...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            splitterModel: 230,
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Datos de la Orden', isTabDisable: false, rootPath:'pages', importPath: 'RootMFG/mktPRDreturn/mktPRDreturnEditBasic.vue' },
                { tabName: 'lines', iconName: 'fas fa-list-ol', textLabel: 'PT Devolución', isTabDisable: false, rootPath:'pages', importPath: 'RootMFG/mktPRDreturn/mktPRDreturnEditLines.vue' },
                { tabName: 'status', iconName: 'fas fa-shipping-fast', textLabel: 'Mi Pedido', isTabDisable: false, rootPath:'pages', importPath: 'RootMFG/mktPRDreturn/mktPRDreturnEditWH.vue' },
