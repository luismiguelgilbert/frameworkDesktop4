...
export default ({
    ...
    data () {
        return {
            moduleName: "mfgLocations", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMFG/mfgLocations',
            rptName_: 'Líneas de Producción', rptLink_: 'mfgLocations', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
