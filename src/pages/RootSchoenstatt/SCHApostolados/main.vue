...
export default ({
    ...
    data () {
        return {
            moduleName: "SCHApostolados", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootSchoenstatt/SCHApostolados',
            rptName_: 'Datos de Apostolado', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
