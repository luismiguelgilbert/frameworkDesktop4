...
<q-form ref="formulario" greedy autofocus no-error-focus spellcheck="false" autocorrect="off" autocapitalize="off" class="q-gutter-sm">
    ...
    <q-input
        ...
        placeholder="Ingrese el nombre del Apostolado (*)" label="Nombre del Apostolado (*)" filled
        v-model="name_es"
        :rules="[
                val => !!val || '* Requerido',
    ...
    <q-input
        label="Comentarios" placeholder="Ingrese comentarios sobre este Apostolado" filled
