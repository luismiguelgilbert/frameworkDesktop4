...
export default ({
    ...
    data () {
        return {
            moduleName: "SCHSectores", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootSchoenstatt/SCHSectores',
            rptName_: 'Datos de Sector', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
