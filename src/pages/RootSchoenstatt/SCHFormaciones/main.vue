...
export default ({
    ...
    data () {
        return {
            moduleName: "SCHFormaciones", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootSchoenstatt/SCHFormaciones',
            rptName_: 'Datos de Formación', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
