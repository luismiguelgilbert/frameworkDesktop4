...
export default ({
    ...
    data () {
        return {
            moduleName: "Bitapeople", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootBitacora/Bitapeople',
            rptName_: 'Ingreso', rptLink_: 'Bitapeople', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        columnKeyName: {
