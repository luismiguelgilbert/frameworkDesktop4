...
export default ({
    ...
    data () {
        return {
            moduleName: "Bitaevents", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootBitacora/Bitaevents',
            rptName_: 'Bitácora', rptLink_: 'Bitaevents', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        columnKeyName: {
