...
export default ({
    ...
    data () {
        return {
            moduleName: "Bitarides", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootBitacora/Bitarides',
            rptName_: 'Viaje', rptLink_: 'Bitarides', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        columnKeyName: {
