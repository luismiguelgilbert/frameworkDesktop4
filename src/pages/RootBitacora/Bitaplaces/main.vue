...
export default ({
    ...
    data () {
        return {
            moduleName: "Bitaplaces", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootBitacora/Bitaplaces',
            rptName_: 'Puntos de Control', rptLink_: 'Bitaplaces', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
