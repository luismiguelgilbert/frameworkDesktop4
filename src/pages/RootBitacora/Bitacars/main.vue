...
export default ({
    ...
    data () {
        return {
            moduleName: "Bitacars", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootBitacora/Bitacars',
            rptName_: 'Vehículos', rptLink_: 'Bitacars', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
