...
export default ({
    ...
    data () {
        return {
            moduleName: "ENSTeams", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootENS/ENSTeams',
            rptName_: 'Datos de Equipo', rptLink_: 'ENSTeams', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
