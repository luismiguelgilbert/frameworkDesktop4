...
export default ({
    ...
    data () {
        return {
            moduleName: "ENSLibros", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootENS/ENSLibros',
            rptName_: 'Datos de Libro', rptLink_: 'ENSLibros', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
