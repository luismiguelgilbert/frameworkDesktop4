...
export default ({
    ...
    data () {
        return {
            moduleName: "ENSMeetWork", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootENS/ENSMeetWork',
            rptName_: 'Reunión de Trabajo', rptLink_: 'ENSMeetWork', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
