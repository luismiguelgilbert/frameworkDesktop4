...
export default ({
    ...
    data () {
        return {
            moduleName: "ENSCalendar", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootENS/ENSCalendar',
            rptName_: 'Calendario ENS', rptLink_: 'ENSCalendar', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
