...
<q-form style="margin: -16px;" ref="formulario" greedy autofocus no-error-focus spellcheck="false" autocorrect="off" autocapitalize="off" class="q-gutter-sm q-pa-md">
    ...
    <div>
      <q-toggle
        v-model="es_consiliario" color="positive" label="Es Consiliario?" :disable="true"
        />
    </div>
    ...
    <q-input
        class="q-mt-lg"
        v-if="es_consiliario==false"
        ref="fecha_matrimonio" :readonly="false"
...
export default ({
  ...
  computed:{
      ...
      es_consiliario: {
          get () { return this.$store.state[this.moduleName].editData.basic.es_consiliario },
          set (val) { this.$store.commit((this.moduleName)+'/updateEditData', {section: 'basic', key: 'es_consiliario', value: val}) }
      },
      sys_user_code: {
