...
export default ({
    ...
    data () {
        return {
            moduleName: "ENSMeetPilot", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootENS/ENSMeetPilot',
            rptName_: 'Reunión de Pilotaje', rptLink_: 'ENSMeetPilot', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
