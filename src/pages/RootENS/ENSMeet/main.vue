...
export default ({
    ...
    data () {
        return {
            moduleName: "ENSMeet", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootENS/ENSMeet',
            rptName_: 'Reunión de Equipo', rptLink_: 'ENSMeet', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
