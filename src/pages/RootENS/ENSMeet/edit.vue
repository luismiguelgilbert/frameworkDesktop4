...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            spSelectName: 'spEnsMeetTeamSelectEdit',
            spUpdateName: 'spEnsMeetTeamUpdate',
            toolbarTitle: "Reunión de Equipo",
            ...
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Información de la Reunión', isTabDisable: false, rootPath:'pages', importPath: 'RootENS/ENSMeet/ENSMeetEditBasic.vue' },
                ...
                { tabName: 'attend', iconName: 'fas fa-users', textLabel: 'Asistencia de Equipistas', isTabDisable: false, rootPath:'pages', importPath: 'RootENS/ENSMeet/ENSMeetEditAsistencia.vue' },
                { tabName: 'priest', iconName: 'fas fa-user-nurse', textLabel: 'Participación del Consiliario', isTabDisable: false, rootPath:'pages', importPath: 'RootENS/ENSMeet/ENSMeetEditPriest.vue' },
                { tabName: 'moments', iconName: 'fas fa-stream', textLabel: 'Momentos de la Reunión', isTabDisable: false, rootPath:'pages', importPath: 'RootENS/ENSMeet/ENSMeetEditMoments.vue' },
                { tabName: 'social', iconName: 'fas fa-birthday-cake', textLabel: 'Reunión Social', isTabDisable: false, rootPath:'pages', importPath: 'RootENS/ENSMeet/ENSMeetEditSocial.vue' },
                { tabName: 'schedule', iconName: 'fas fa-calendar-alt', textLabel: 'Agendar Siguiente Reunión', isTabDisable: false, rootPath:'pages', importPath: 'RootENS/ENSMeet/ENSMeetEditCalendar.vue' },
            ...
            editDataSaveProperties: [
                ...
                { name: 'ensMeetTeamPersonas', filterBy: null, fields: ['sys_user_code','attended','absentReasonID'] },
