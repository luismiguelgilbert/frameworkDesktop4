...
export default ({
    ...
    data () {
        return {
            moduleName: "ENSServicios", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootENS/ENSServicios',
            rptName_: 'Datos de Servicio', rptLink_: 'ENSServicios', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
