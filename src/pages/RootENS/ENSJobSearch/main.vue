...
export default ({
    ...
    data () {
        return {
            moduleName: "ENSJobSearch", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootENS/ENSJobSearch',
            rptName_: 'Bolsa de Trabajo ENS', rptLink_: 'ENSJobSearch', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
