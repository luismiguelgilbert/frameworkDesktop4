...
export default ({
    ...
    data () {
        return {
            moduleName: "Roles", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootSystem/Roles',
            rptName_: 'Detalle de Roles', rptLink_: 'sysRoles', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
