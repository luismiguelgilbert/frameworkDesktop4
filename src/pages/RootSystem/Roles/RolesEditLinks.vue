    ...
    computed:{
        ...
        ticked_links: {
            get () { 
                ...
                return this.$store.state[this.moduleName].editData.ticked_links.map(x=>x.sys_link_id)//así devuelve en formato correcto para q-tree
            },
            set (val) { 
                this.$store.commit((this.moduleName)+'/updateEditDataTickedLinks', val)
            }  
        }
    },
})
