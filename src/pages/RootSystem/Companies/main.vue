...
export default ({
    ...
    data () {
        return {
            moduleName: "Companies", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootSystem/Companies',
            rptName_: 'Datos de Compañías', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
