    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            moduleTabs: [
                 ...
                 { tabName: 'system', iconName: 'fas fa-cog', textLabel: 'Configuración', isTabDisable: false, rootPath:'pages', importPath: 'RootSystem/Companies/CompaniesEditSystem.vue' },
                 ...
                 { tabName: 'rucLengths', iconName: 'fas fa-passport', textLabel: 'Control de RUCs', isTabDisable: false, rootPath:'components', importPath: 'editForm/editFormGrid.vue',
                    tabConfig: { 
                        dataName: 'rucLengths', 
                        keyColumn: 'codigo',  listKeyColumn: 'codigo',
                        insertAllowed: true, insertType: 'form',  insertList: null,
                        deleteAllowed: true,
                        columns: [
                            //'string' | 'number' | 'date' | 'boolean' | 'object' | 'datetime'
                            {alignment: 'left', allowEditing: false, isDataRequired: true, caption: 'Código', dataField: 'codigo', listDataField: 'codigo', dataType: 'number', visible: false },
                            {alignment: 'left', allowEditing: true, isDataRequired: true, caption: 'Longitud', dataField: 'longitud', listDataField: 'longitud', dataType: 'number', visible: true },
            ...
            editDataSaveProperties: [
                ...
                { name: 'rucLengths', filterBy: null, fields: ['longitud'] }
            ],
