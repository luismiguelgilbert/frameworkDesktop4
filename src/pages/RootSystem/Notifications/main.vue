...
export default ({
    ...
    data () {
        return {
            moduleName: "Notifications", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMaster/Notifications',
            rptName_: 'Detalle de Notificaciones', rptLink_: 'sysNotification', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
