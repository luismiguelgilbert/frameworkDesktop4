...
>
    <template v-slot:top>
        <div :class="'text-h6 '+(userColor=='blackDark'?'text-white':'text-primary')" >Marque los usuarios a quienes desee asignar acceso a esta compañía ({{users.filter(x=>x.is_allowed).length}})</div>
        <q-space />
