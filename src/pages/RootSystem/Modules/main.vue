...
export default ({
    ...
    data () {
        return {
            moduleName: "Modules", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootSystem/Modules',
            rptName_: 'Detalle de Módulos', rptLink_: 'sysModules', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
