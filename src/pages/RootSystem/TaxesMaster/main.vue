...
export default ({
    ...
    data () {
        return {
            moduleName: "TaxesMaster", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootSystem/TaxesMaster',
            rptName_: 'Datos de Impuesto', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
