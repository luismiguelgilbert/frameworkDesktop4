...
export default ({
    data () {
        return {
            moduleName: "Users", isDialogVisible: false, fileToUpload: null,
        }
    },
    methods:{
            ...
            this.$axios.post(this.apiURL+'sp_sys_user_picture_upload',
                {
                    ...
                    editing_sys_user_code: this.editMode?0:this.editRecord.row.sys_user_code_ux
                }
    ...
    computed:{
        ...
        userPhoto: { 
            get () { return this.$store.state[this.moduleName].editData.basic.userPhoto }, 
            set (val) { this.$store.commit((this.moduleName)+'/updateEditData', {section: 'basic', key: 'userPhoto', value: val}) }  
        },
        editMode: { 
