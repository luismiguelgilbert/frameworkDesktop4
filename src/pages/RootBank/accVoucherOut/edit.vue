    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            moduleTabs: [
                ...
                //{ tabName: 'print', iconName: 'fas fa-print', textLabel: 'Imprimir Documento', isTabDisable: false, rootPath:'components', importPath: 'paymentsView/paymentsPrint' },
                { tabName: 'print', iconName: 'fas fa-print', textLabel: 'Ver Comprobante', isTabDisable: false, rootPath:'components', importPath: 'mainReport/reportComponentPDF' },
                { tabName: 'printCheck', iconName: 'fas fa-print', textLabel: 'Imprimir Cheque', isTabDisable: false, rootPath:'pages', importPath: 'RootBank/accVoucherOut/accVoucherOutEditCheque.vue' },
