...
export default ({
    ...
    data () {
        return {
            moduleName: "AccPeriods", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootAccounting/AccPeriods',
            rptName_: 'Datos de Periodo', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
