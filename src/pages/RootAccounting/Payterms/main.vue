...
export default ({
    ...
    data () {
        return {
            moduleName: "Payterms", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootAccounting/Payterms',
