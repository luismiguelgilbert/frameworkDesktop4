    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            moduleTabs: [
                ...
                { tabName: 'system', iconName: 'fas fa-book', textLabel: 'Detalle del Asiento', isTabDisable: false, rootPath:'pages', importPath: 'RootAccounting/AccMoves/AccMovesEditLines' },
