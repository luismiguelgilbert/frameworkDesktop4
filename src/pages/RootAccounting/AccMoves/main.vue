...
export default ({
    ...
    data () {
        return {
            moduleName: "AccMoves", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootAccounting/AccMoves',
            rptName_: 'Datos de Asiento', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
