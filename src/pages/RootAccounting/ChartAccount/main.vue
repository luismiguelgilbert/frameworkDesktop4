...
export default ({
    ...
    data () {
        return {
            moduleName: "ChartAccount", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootAccounting/ChartAccount',
            rptName_: 'Datos de Cuentas', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
