...
export default ({
    ...
    data () {
        return {
            moduleName: "accPaymentMethods", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootAccounting/accPaymentMethods',
            rptName_: 'Datos de Usuario', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
