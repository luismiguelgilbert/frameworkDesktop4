...
export default ({
    ...
    data () {
        return {
            moduleName: "partnerMasterGroups", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootAccounting/partnerMasterGroups',
            rptName_: 'Datos de Grupo de Socio', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
