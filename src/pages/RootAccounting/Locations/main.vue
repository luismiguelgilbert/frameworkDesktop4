...
export default ({
    ...
    data () {
        return {
            moduleName: "Locations", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootAccounting/Locations',
            rptName_: 'Datos de Establecimientos', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
