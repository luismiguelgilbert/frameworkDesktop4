...
import basicComponent from './invMasterGroupsEditBasic'
import historyComponent from './invMasterGroupsEditHistory'
...
export default ({
  ...
  data () {
    return {
        moduleName: "invMasterGroups", router: this.$router,
  ...
  methods:{
    ...
    loadData(){
        ...
        this.$axios({
            method: 'GET',
            url: this.apiURL + 'spInvMasterGroupsSelectEdit',
    ...
    saveData(){
        this.$q.dialog({
                ...
                this.$axios.post( this.apiURL + 'spInvMasterGroupsUpdate', {
                        userCode: this.userCode,
                        userCompany: this.userCompany,
