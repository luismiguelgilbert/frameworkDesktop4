...
export default ({
    ...
    data () {
        return {
            moduleName: "invMasterGroups", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootAccounting/invMasterGroups',
            rptName_: 'Datos de Grupo de Item', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
