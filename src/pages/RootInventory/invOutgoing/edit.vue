...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            splitterModel: 230,
            moduleTabs: [
                 { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Documento de Egreso', isTabDisable: false, rootPath:'pages', importPath: 'RootInventory/invOutgoing/invOutgoingEditBasic.vue' }
                ,{ tabName: 'items', iconName: 'fas fa-boxes', textLabel: 'Item Entregados', isTabDisable: false, rootPath:'pages', importPath: 'RootInventory/invOutgoing/invOutgoingEditLines.vue' }
                ,{ tabName: 'lots', iconName: 'fas fa-barcode', textLabel: 'Lotes y Series', isTabDisable: false, rootPath:'pages', importPath: 'RootInventory/invOutgoing/invOutgoingEditLots.vue' }
