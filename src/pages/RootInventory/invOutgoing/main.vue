...
export default ({
    ...
    data () {
        return {
            moduleName: "invOutgoing", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootInventory/invOutgoing',
            rptName_: 'Egreso de Bodega', rptLink_: 'invOutgoing', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
