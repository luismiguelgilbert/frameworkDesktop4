...
export default ({
    ...
    data () {
        return {
            moduleName: "invIncoming", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootInventory/invIncoming',
            rptName_: 'Ingreso a Bodega', rptLink_: 'invIncoming', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
