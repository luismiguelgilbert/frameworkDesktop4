...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            spSelectName: 'spInvKardexIncomingSelectEdit',
            spUpdateName: 'spInvKardexIncomingUpdate',
            toolbarTitle: "Ingreso", //aunque puntualmente este módulo realmente toma el número de orden de ingreso (cabecera) y muestra todas las líneas
            startTab: 'basic',
            splitterModel: 230,
            moduleTabs: [
                 { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Documento de Ingreso', isTabDisable: false, rootPath:'pages', importPath: 'RootInventory/invIncoming/invIncomingEditBasic.vue' }
                ,{ tabName: 'items', iconName: 'fas fa-boxes', textLabel: 'Item Recibidos', isTabDisable: false, rootPath:'pages', importPath: 'RootInventory/invIncoming/invIncomingEditLines.vue' }
                ,{ tabName: 'lots', iconName: 'fas fa-barcode', textLabel: 'Lotes y Series', isTabDisable: false, rootPath:'pages', importPath: 'RootInventory/invIncoming/invIncomingEditLots.vue' }
            ...
            editDataSaveProperties: [
                ...
                { name: 'lines', filterBy: { field: 'newQuantity', operator: '>', condition: 0 }, fields: ['stockID','whID','invID','debit_account_id','credit_account_id','newQuantity','price','lineUntaxed','prjID','mktTypeID','headerID','lineID'] },
                { name: 'lots', filterBy: null, fields: null },
