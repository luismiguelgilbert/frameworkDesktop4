...
<div style="margin: -16px;">
            ...
            <q-menu anchor="top right" self="top left" >
              <q-list>
                <q-item clickable v-ripple v-close-popup :disable="maingridSelectedRowKeys.length<=0 || editStatus.editMode=='edit'" @click="receiveAll">
                  ...
                  <q-item-section>
                      <q-item-label>Recibir Todo</q-item-label>
                  </q-item-section>
                </q-item>
  ...
  <DxDataGrid
    ...
    >
      ...
      <DxColumn caption="Item" data-field="invName" name="invName" data-type="string" :allow-editing="false" alignment="left" :visible="true" :width="230" />
      ...
      <DxColumn caption="Recibido" data-field="quantityRcvd" name="quantityRcvd" data-type="number" :allow-editing="false" alignment="right" :visible="true" :width="80" />
      <DxColumn caption="Recibido Esta Orden" data-field="quantityRcvdThisMove" name="quantityRcvdThisMove" data-type="number" :allow-editing="false" alignment="right" :visible="true" :width="150" />
      
      <DxColumn caption="Cancelado" data-field="quantityCancel" name="quantityCancel" data-type="number" :allow-editing="false" alignment="right" :visible="true" :width="100"  />
      <DxColumn caption="Pendiente" data-field="quantityOpen" name="quantityOpen" data-type="number" :allow-editing="false" alignment="right" :visible="true" :width="100" />
      <DxColumn caption="Recibir" data-field="newQuantity" name="newQuantity" data-type="number" :allow-editing="true" alignment="center" :visible="true" :cssClass="userColor=='default'?'bg-grey-2':'bg-grey-9'" :minWidth="125" :editor-options="{ min:0 }" />
      />
  </DxDataGrid>
