...
<div style="margin: -16px;">
   <q-table
    ...
    <template v-slot:body="props">
      <q-tr :props="props" >
        <q-td auto-width>
          <q-checkbox v-model="props.selected"  dense :title="props.row.stockID" />
        </q-td>
        ...
        get() {
          ...
          if(this.editMode){
            columnas = [
              ...
              { name: 'expectedDate', required: true, label: 'Fecha Estimada (aaaa/mm/dd)', align: 'left', field: row => row.expectedDate, sortable: true, style: 'min-width: 130px;' },
            ]
          }else{
            columnas = [
              { name: 'hasError', required: true, label: '', align: 'center', field: row => row.uploaded, sortable: true },
