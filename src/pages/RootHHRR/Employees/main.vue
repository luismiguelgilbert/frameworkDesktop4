...
export default ({
    ...
    data () {
        return {
            moduleName: "Employees", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootHHRR/Employees',
            rptName_: 'Datos de Empleado', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
