...
export default ({
    ...
    data () {
        return {
            moduleName: "salesSO", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootSales/salesSO',
            rptName_: 'Orden de Venta', rptLink_: 'salesSO', rptLinkCompany_: true, rptType_: 'ssrs',
