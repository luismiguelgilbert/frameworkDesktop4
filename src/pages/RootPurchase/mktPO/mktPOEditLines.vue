...
<div class="row ">
  ...
  <q-table
    ...
    <template v-slot:top >
        ...
        <q-space />
        <q-btn size="sm" icon="fas fa-calculator" color="primary" flat no-caps title="Calcula datos de líneas seleccionadas" class="q-mr-sm" :disable="selected.length<=0" @click="isStatsDialog=!isStatsDialog" />
