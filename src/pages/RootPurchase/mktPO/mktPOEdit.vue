...
import filesComponent from './mktPOEditFiles'
import historyComponent from './mktPOEditHistory'
...
export default ({
  ...
  data () {
    return {
        moduleName: "mktPO", router: this.$router,
  ...
  methods:{
    ...
    loadData(){
        ...
        this.$axios({
            method: 'GET',
            url: this.apiURL + 'spMktPOSelectEdit',
