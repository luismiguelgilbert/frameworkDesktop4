...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            spSelectName: 'spMktPOSelectEdit',
            spUpdateName: 'spMktPOUpdate',
            toolbarTitle: "Orden de Compra",
            startTab: 'basic',
            splitterModel: 230,
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Datos de la Orden', isTabDisable: false, rootPath:'pages', importPath: 'RootPurchase/mktPO/mktPOEditBasic.vue' },
                { tabName: 'lines', iconName: 'fas fa-list-ol', textLabel: 'Items Pedidos', isTabDisable: false, rootPath:'pages', importPath: 'RootPurchase/mktPO/mktPOEditLines.vue' },
                { tabName: 'status', iconName: 'fas fa-shipping-fast', textLabel: 'Mi Pedido', isTabDisable: false, rootPath:'pages', importPath: 'RootPurchase/mktPO/mktPOEditWH.vue' },
