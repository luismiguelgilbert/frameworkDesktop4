...
export default ({
    ...
    data () {
        return {
            moduleName: "mktPR", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootPurchase/mktPR',
            rptName_: 'Datos de Requisición', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
