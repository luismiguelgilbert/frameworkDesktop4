...
<div class="row ">
  ...
  <q-table
    ...
    <template v-slot:top >
        ...
        <q-btn v-if="editMode==true" :label="$q.screen.gt.sm?'Descuento':''" size="sm" title="Aplicar un mismo descuento a filas seleccionadas" @click="batchUpdateDiscount" icon="fas fa-percent" color="primary" flat no-caps   :disable="selected.length<=0" />
    </template>
