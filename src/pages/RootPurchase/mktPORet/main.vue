...
export default ({
    ...
    data () {
        return {
            moduleName: "mktPORet", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootPurchase/mktPORet',
            rptName_: 'Devolución de Compra', rptLink_: 'mktPORet', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
