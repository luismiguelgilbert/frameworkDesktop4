...
<div style="margin: -16px;">
  <q-toolbar class="no-padding">
    <q-btn label="Ingresos a Bodega" icon="fas fa-file-alt" color="primary" flat stretch @click="isRequisicionesDialog=true" :disable="!allow_row_insert" />
  ...
  <DxDataGrid
    ...
    >
      ...
      <DxColumn caption="# Ingreso" data-field="moveID" name="moveID" data-type="number" :allow-editing="false" alignment="right" :width="120" :visible="false" cssClass="text-primary" />
      <DxColumn caption="Orden Ingreso #" data-field="kardexID" name="kardexID" data-type="number" :allow-editing="false" alignment="right" :width="120" :visible="false" cssClass="text-primary" />
    ...
    >
        ...
        <div style="margin: -15px;">
          ...
          <DxDataGrid
            ...
            <DxColumn caption="# OC" data-field="mktPOHeaderID" data-type="number" :allow-editing="false" alignment="left" :visible="true" :minWidth="70" />
            <DxColumn caption="# OC Línea" data-field="mktPOLineID" data-type="number" :allow-editing="false" alignment="left" :visible="true" :minWidth="70" />
            <DxColumn caption="Item" data-field="invName" data-type="string" :allow-editing="false" alignment="left" :visible="true" :minWidth="200" />
            <DxColumn caption="Cantidad Recibida" data-field="quantity" data-type="number" :allow-editing="false" alignment="right" :visible="true" :width="120"  />
            ...
            <DxColumn caption="Ingreso #" data-field="moveID" data-type="number" :allow-editing="false" alignment="left" :visible="true" :width="70"  />
            <DxColumn caption="Orden Ingreso #" data-field="kardexID" data-type="number" :allow-editing="false" alignment="left" :visible="true" :width="120"  />
      ...
      this.requisiciones.filter(x=>this.requisicionesSelectedRowKeys.some(y=>y==x.moveID)).map(row=>{
        if( newGridData.some(t=>t.moveID==row.moveID) && newGridData.some(t=>t.kardexID==row.kardexID) ){
          ...
          const newRow = {
            ...
            lineTotal: (parseFloat( parseFloat(parseFloat(row.quantityReturnedNew * row.price).toFixed(6)) + parseFloat(newTaxAmount.toFixed(6)) ).toFixed(6)),
            quantityOpen: 0,
            quantityReturned: 0,
            prjID: 0,
            ...
            stockID: row.stockID,
            moveID: row.moveID,
            mktPO_headerID: row.mktPO_headerID,
            mktPO_lineID: row.mktPO_lineID
          }
